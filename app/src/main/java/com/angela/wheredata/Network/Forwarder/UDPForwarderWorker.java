...
import com.angela.wheredata.Network.Protocol.UDP.UDPHeader;
...
public class UDPForwarderWorker extends Thread {
    private final String TAG = UDPForwarderWorker.class.getSimpleName();
        ...
        try {
            while (!isInterrupted()) {
                ...
                if (received != null) {
                    ...
                    Log.d(TAG, "response is " + response.debugString());
